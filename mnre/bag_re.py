    ...
    def train_model(self, metric='auc'):
        ...
        for epoch in range(self.max_epoch):
            ...
            for iter, data in enumerate(t):
                ...
                lang_mask = data[3]
                args = data[4:]
                logits = self.model(label, scope, lang_mask, *args, bag_size=self.bag_size)
    ...
    def eval_model(self, eval_loader):
        ...
        with torch.no_grad():
            ...
            for iter, data in enumerate(t):
                ...
                lang_mask = data[3]
                args = data[4:]
                logits = self.model(None, scope, lang_mask, *args, train=False, bag_size=self.bag_size)  # results after softmax
